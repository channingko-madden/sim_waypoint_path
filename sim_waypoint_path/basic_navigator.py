...
class BasicNavigator(Node):
    ...
    def goToPose(self, pose):
        ...
        #send_goal_future = self.nav_to_pose_client.send_goal(goal_msg, feedback_callback=self._feedbackCallback)
    ...
    def _waitForNodeToActivate(self, node_name):
        ...
        self.info('Waiting for ' + node_service + ' to be ready..')
        while not state_client.service_is_ready():
    ...
    def _setInitialPose(self):
        ...
        self.info('Published Initial Pose')
        return
